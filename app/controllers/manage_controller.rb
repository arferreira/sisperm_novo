class ManageController < ApplicationController
  ...
  def admin
    if current_user.login == 'barellywgp' || current_user.login == 'bazzananas' || current_user.login == 'kaiquejcs' || current_user.login == 'mirallesfvo' || current_user.login == 'cordobalm'
